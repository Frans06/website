...
- Create two apps on Fly, one for staging and one for production:
  ...
  ```sh
  fly apps create personal-website-dbd8
  fly apps create personal-website-dbd8-staging
  ```
...
- Add a `SESSION_SECRET` to your fly app secrets, to do this you can run the following commands:
  ...
  ```sh
  fly secrets set SESSION_SECRET=$(openssl rand -hex 32) --app personal-website-dbd8
  fly secrets set SESSION_SECRET=$(openssl rand -hex 32) --app personal-website-dbd8-staging
  ```

  > **Note:** When creating the staging secret, you may get a warning from the Fly CLI that looks like this:
  >
  > ```
  > WARN app flag 'personal-website-dbd8-staging' does not match app name in config file 'personal-website-dbd8'
  > ```
  >
...
- Create a database for both your staging and production environments. Run the following:
  ...
  ```sh
  fly postgres create --name personal-website-dbd8-db
  fly postgres attach --app personal-website-dbd8 personal-website-dbd8-db

  fly postgres create --name personal-website-dbd8-staging-db
  fly postgres attach --app personal-website-dbd8-staging personal-website-dbd8-staging-db
  ```
